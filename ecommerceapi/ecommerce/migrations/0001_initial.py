# Generated by Django 5.0.4 on 2024-04-15 09:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sold_inventory', models.IntegerField(blank=True, default=0)),
        ...
        migrations.AddField(
            model_name='order',
            name='products',
            field=models.ManyToManyField(through='ecommerce.OrderDetail', to='ecommerce.product'),
        ),
        migrations.CreateModel(
            name='Store',
            fields=[
        ...
        migrations.AddField(
            model_name='product',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products_store', to='ecommerce.store'),
        ),
    ]
